"""
Django settings for PhotoshootApp project.
...
AI_ENGINE = {
    ...
    'FACE_RECOGNITION_MODEL': os.getenv('FACE_RECOGNITION_MODEL', 'deepface'),
    'PROCESSING_THREADS': int(os.getenv('AI_PROCESSING_THREADS', '4')),
